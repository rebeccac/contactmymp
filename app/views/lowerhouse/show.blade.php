  ...
  <div class="row 1" data-equalizer>
     ...
     <div class="large-10 medium-10 columns main" data-equalizer-watch>
        <div class="row 2" data-equalizer>
         ...
         <div class="large-10 medium-10 columns mp_light" data-equalizer-watch>
            <!-- CONTENT -->
            <div class="row 3" data-equalizer>
               <div class="large-12 medium-12 columns pol_info1 mp_medium" data-equalizer-watch>
            ...
            @if(!is_null($mp['positions']))
               <div class="row 3a" data-equalizer>
                  <div class="large-12 medium-12 columns pol_info2 mp_dark" data-equalizer-watch>
                        {{ $mp['positions'] }}
                  </div>
               </div><!-- row 3a -->
            @endif
